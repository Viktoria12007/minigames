...
function hero() {
    ...
    add(card, heroTitle, element('p', 'hero__text', 'Discover hundreds of curated casual mini-games. Play instantly in your browser — puzzle, match 3, farm, and board classics.'), link('Browse Library', '#library', 'hero__button button'));
    add(hero, art, card);
    return hero;
}
