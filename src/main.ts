...
function developer(): HTMLElement {
    ...
    add(card, title, element('p', 'developer__text', `Want to see your game on MiniGames? We're always looking for fun, engaging mini games to add to our platform. Submit your game and reach thousands of players!`), button('Submit Form', 'button developer__button'), element('small', 'developer__contact', 'or contact us at developers@minigames.com'));
