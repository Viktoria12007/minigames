...
function modalElement(): HTMLDivElement {
...
add(app, header(), burgerMenu(), main, footer(), modal);
...
function setAuthMode(mode: AuthMode): void {
  ...
  add(
    switchText,
    document.createTextNode(isLoginMode ? "Don't have an account? " : 'Already have an account? '),
    switchButton,
  );
